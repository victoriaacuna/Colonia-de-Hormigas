...
public class Feromonas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cantidad de feromonas en los caminos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Feromonas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Feromonas(g,numIt).setVisible(true);
            }
        });
    }
